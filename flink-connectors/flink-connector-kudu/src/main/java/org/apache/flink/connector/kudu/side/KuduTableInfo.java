...
package org.apache.flink.connector.kudu.side;
...
public class KuduTableInfo implements Serializable {
    ...
    private String name;
    private org.apache.flink.connector.kudu.side.CreateTableOptionsFactory createTableOptionsFactory = null;
    private org.apache.flink.connector.kudu.side.ColumnSchemasFactory schemasFactory = null;
    ...
    public KuduTableInfo createTableIfNotExists(
            org.apache.flink.connector.kudu.side.ColumnSchemasFactory schemasFactory,
            org.apache.flink.connector.kudu.side.CreateTableOptionsFactory createTableOptionsFactory) {
