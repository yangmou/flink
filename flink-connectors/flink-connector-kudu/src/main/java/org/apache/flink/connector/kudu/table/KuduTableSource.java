...
import org.apache.flink.connector.kudu.batch.KuduRowInputFormat;
...
import static org.apache.flink.connector.kudu.table.utils.KuduTableUtils.toKuduFilterInfo;
...
public class KuduTableSource implements StreamTableSource<Row>,
    ...
    public KuduTableSource(
            KuduReaderConfig.Builder configBuilder, KuduTableInfo tableInfo,
