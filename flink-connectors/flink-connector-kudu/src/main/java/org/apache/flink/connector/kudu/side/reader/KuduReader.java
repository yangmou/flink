...
package org.apache.flink.connector.kudu.side.reader;
...
public class KuduReader implements AutoCloseable {
    ...
    public KuduReader(
            ...
            List<KuduFilterInfo> tableFilters) throws IOException {
    ...
    public KuduInputSplit[] createInputSplits(int minNumSplits) throws IOException {
        ...
        List<KuduScanToken> tokens = scanTokens(
                tableFilters,
                tableProjections,
                readerConfig.getRowLimit());
